...
public abstract partial class SearchableViewModel<T> : NavigableViewModel
{
    ...
    private void SyncFilteredItems(List<T> newItems)
    {
        ...
        // ==========================================================
        // После изменения FilteredItems уведомляем производные
        // ViewModel о завершении обновления коллекции.
        // Это позволяет обновить любые вычисляемые свойства,
        // зависящие от FilteredItems (например, счётчики).
        // ==========================================================
        OnFilteredItemsChanged();
    }

    // ==========================================================
    // Виртуальный метод вызывается после каждого обновления
    // FilteredItems. По умолчанию ничего не делает.
    // Производные ViewModel могут переопределить его.
    // ==========================================================
    protected virtual void OnFilteredItemsChanged()
    {
    }
